...
class ApprovalCommentTests(TestCase):
    ...
    def test_clean_approval_reason(self):
        ...
        self.assertEqual(
            clean_approval_reason("no content change in last article"), "no content change"
        )
    ...
    def test_group_consecutive_revisions(self):
        ...
        self.assertEqual(
            group_consecutive_revisions([1, 2, 5, 6, 7, 10]), [[1, 2], [5, 6, 7], [10]]
        )
...
class ApprovalCommentIntegrationTests(TestCase):
    ...
    def test_batch_processing_workflow(self):
        ...
        self.assertEqual(
            batch_result["successful_pages"], 1
        )  # Only first page has approvable revisions
